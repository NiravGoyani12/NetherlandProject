...
const features = require(`../output/${brand}-scenarios.json`);
...
try {
  ...
  console.log(`File created: scenario-reports/output/${brand.toUpperCase()}_${getDate()}_Scenario_Report.xlsx`);
} catch (e) {
  console.log(`Error encountered while trying to write file. Error: ${e}`);
}

Feature: Contact Us Overview Page
  ...
  @ContactUsOverviewPage @UnifiedExperience @EER @HelpApp @P1 @ExcludeUat
  ...
  Scenario Outline: Contact us overview page - Check all modules are display when visit the page
    ...
    Examples:
      | locale | langCode | url        |
      | nl      | default  | /help/contactus |

  @FullRegression
  @Desktop @Mobile
  @Chrome @FireFox @Safari
  @ContactUsOverviewPage @UnifiedExperience @EER @HelpApp @P3 @ExcludeUat
  ...
  Scenario Outline: Contact us overview page - Minimize chat window and re-open to close it
    ...
    Examples:
      | locale | langCode | url        |
      | it     | default  | /help/contactus |

  @FullRegression
  @Desktop @Mobile
  @Chrome @FireFox @Safari
  @ContactUsOverviewPage @UnifiedExperience @EER @HelpApp @P2 @GiftCard @ExcludeUat
  ...
  Scenario Outline: Contact us overview page - User should be able to see Gift card in side bar with nesting links
    ...
    Examples:
      ...
      | uk     | salesVoucherGiftCardsText | salesVoucherGiftCardsLabel | /help/contactus |

Feature: Unified - Contact Us Form
  ...
  @UnifiedContactUsPage @UnifiedExperience @EER @HelpApp @P3
  Scenario Outline: Contact us page - Character countdown message is displayed
    ...
    Examples:
      ...
      | default | default  | 0                  | 0/2000        | /contactus |

    @tms:UTR-11638
    Examples:
      | locale           | langCode         | messageInputLength | messageLength | url        |
      | multiLangDefault | multiLangDefault | 23                 | 23/2000       | /contactus |

  @FullRegression
  @Desktop @Mobile
  @Chrome @FireFox @Safari @Translation @Lokalise
  @UnifiedContactUsPage @UnifiedExperience @EER @HelpApp @ExcludeSIT
  Scenario Outline: Contact us page - User can see error message when submitting without captcha
    ...
    Examples:
      ...
      | default | default  | 1           | /contactus |

    @tms:UTR-11642
    Examples:
      | locale           | langCode         | genderIndex | url        |
      | multiLangDefault | multiLangDefault | 2           | /contactus |
  ...
  Scenario Outline: Contact us page - User is restricted to enter not more than 80 characters in Item number field
    ...
    Examples:
      ...
      | default | default  | 85                    | /contactus |

    @tms:UTR-11644
    Examples:
      | locale           | langCode         | itemNumberInputLength | url        |
      | multiLangDefault | multiLangDefault | 85                    | /contactus |
  ...
  Scenario Outline: Contact us page - User can see error message is displayed if enters invalid input
    ...
    Examples:
      ...
      | default | default  | #requestTypePaymentText | EmailInput | abc@234     | EmailErrorMsg | /contactus |
      | default | default  | #requestTypeOtherText   | EmailInput | abc@234     | EmailErrorMsg | /contactus |

    @tms:UTR-11648
    Examples:
      | locale           | langCode         | requestType             | inputField | invalidData | inputError    | url        |
      | multiLangDefault | multiLangDefault | #requestTypeOtherText   | PhoneInput | abc         | PhoneErrorMsg | /contactus |
      | multiLangDefault | multiLangDefault | #requestTypePaymentText | PhoneInput | @@456       | PhoneErrorMsg | /contactus |
  ...
  Scenario Outline: Contact us page - Message Length error displayed when limit exceeded
    ...
    Examples:
      ...
      | default | default  | 2001               | 2001/2000     | MessageLengthError | /contactus |

    @tms:UTR-11650
    Examples:
      | locale           | langCode         | messageInputLength | messageLength | inputError         | url        |
      | multiLangDefault | multiLangDefault | 2005               | 2005/2000     | MessageLengthError | /contactus |

  @FullRegression
  @Desktop @Mobile
  @Chrome @FireFox @Safari
  @UnifiedContactUsPage @UnifiedExperience @EER @HelpApp @P2 @Translation @Lokalise
  Scenario Outline: Contact us page - User should be able to change the category after subcategory selection, subcategory throwing error if not selected.
    ...
    Examples:
      | locale           | langCode         | genderIndex | url        |
      | multiLangDefault | multiLangDefault | 1           | /contactus |

  @FullRegression
  @Desktop @Mobile
  @Chrome @FireFox @Safari @Translation @Lokalise
  @UnifiedContactUsPage @UnifiedExperience @EER @HelpApp @P2
  @tms:UTR-13218
  Scenario Outline: Contact us page - Logged in user should be able to see email id populated, also error message when submitting without captcha
    ...
    Examples:
      ...
      | default | myaccount/details | 2           | /contactus |
  ...
  Scenario Outline: Contact us page - User is notified with error messages for the mandatory fields if left empty
    ...
    Examples:
      ...
      | default | EmailErrorMsg | /contactus |
  ...
  Scenario Outline: Contact us page - User should be able to see left side bar with nesting links
    ...
    Examples:
      | locale  | category         | url        |
      | default | WomenSidebarLink | /contactus |
      | default | StoreLocator     | /contactus |

  @FullRegression
  @Desktop @Mobile
  @Chrome @FireFox @Safari
  @UnifiedContactUsPage @UnifiedExperience @EER @HelpApp @P2 @GiftCard
  ...
  Scenario Outline: Contact us page - User should be able to see Gift card in request type with sub-category
    ...
    Examples:
      ...
      | at     | PromotionCodesGiftCards | PurchaseGiftCard | /contactus |
      | at     | PromotionCodesGiftCards | RedeemGiftCard   | /contactus |
  ...
  Scenario Outline: Contact us page - Return the error when not enter the promotion code to submit a request
    ...
    Examples:
      ...
      | default          | default          | 2           | /contactus | RequestNewCodeText    |
      | multiLangDefault | multiLangDefault | 1           | /contactus | ForgotToApplyCodeText |

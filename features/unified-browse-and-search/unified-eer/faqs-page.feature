Feature: Unified Customer service FAQ page
  ...
  Scenario Outline: Unified FAQ page - User should be able to navigate to main FAQ category page from FAQ Question page using Back menu
    Given I am on locale <locale> of url /faqs of langCode <langCode> with accepted cookies
  ...
  @Desktop
  @Chrome @FireFox @Safari
  @UnifiedFaq @UnifiedExperience @EER @HelpApp
  ...
  @Desktop @Mobile
  @Chrome @FireFox @Safari
  @UnifiedFaq @UnifiedExperience @EER @HelpApp @P2 @Translation
  @tms:UTR-13188
  ...
  @Desktop @Mobile
  @Chrome @FireFox @Safari
  @UnifiedFaq @UnifiedExperience @EER @HelpApp @P3
  ...
  @Desktop
  @Chrome @FireFox @Safari
  @UnifiedFaq @UnifiedExperience @EER @HelpApp @tms:EER-3987 @P1 @Translation
  ...
  @UnifiedFaq @UnifiedExperience @EER @HelpApp @tms:UTR-17360 @GiftCard
  Scenario Outline: FAQ page - User can check their gift card balance
    ...
    Examples:
      ...
      | at      | default  | salesVoucherGiftCardsText | /faqs |
